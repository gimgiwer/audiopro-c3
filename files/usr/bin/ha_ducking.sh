...
duck_down() {
    # Smoothly ramp down background music to 20% (-14 dB attenuation)
...
duck_up() {
    # Smoothly restore background music volume back to 100%
...
case "$ACTION" in
    ...
    play|tts)
        ...
        ;;
    *)
        echo "Usage: $0 {start|stop|play <file_or_url>}"
        exit 1
        ;;
esac
